<template>
  <div>
    ...
    <v-btn class="mainAltButton mb-2" :href="firefoxLink" target="_blank" aria-label="Install on Firefox">
      <v-icon style="margin-right: 0.5em">mdi-firefox</v-icon>
      {{ $vuetify.lang.t("$vuetify.install.firefox") }}
    </v-btn>

    <v-btn class="mainAltButton mb-2" :href="chromeLink" target="_blank" aria-label="Install on Chrome">
      <v-icon style="margin-right: 0.5em">mdi-google-chrome</v-icon>
      {{ $vuetify.lang.t("$vuetify.install.chrome") }}
    </v-btn>

    <v-btn class="mainAltButton mb-2" :href="chromeLink" target="_blank" aria-label="Install on Microsoft Edge">
      <v-icon style="margin-right: 0.5em">mdi-microsoft-edge</v-icon>
      {{ $vuetify.lang.t("$vuetify.install.edge") }}
    </v-btn>

    <v-btn class="mainAltButton mb-2" :href="chromeLink" target="_blank" aria-label="Install on Opera">
      <v-icon style="margin-right: 0.5em">mdi-opera</v-icon>
      {{ $vuetify.lang.t("$vuetify.install.opera") }}
    </v-btn>

    <v-btn class="mainAltButton mb-2" :href="chromeLink" target="_blank" aria-label="Install on Brave">
      <!-- brave logo icon -->
      <svg
    ...
    <p style="color: #b3b3b3; margin-top: 0.5rem; margin-bottom: 0.5rem">
