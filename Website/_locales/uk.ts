...
export default {
  ...
  api: {
    ...
    rights: {
      ...
      subtitle: "Використання цього відкритого API сторонніми особами дозволено з наступними обмеженнями:",
      bullet1: "Атрибуція: ",
      bullet1text:
    ...
    fetching: {
      ...
      error2: 'YouTube ID у невірному форматі видасть код помилки 400 "Bad Request"',
    },
  },
  help: {
    name: "Допомога",
    ...
    bullet4c: "Зробіть знімок екрана сторінки з встановленими розширеннями вашого браузера.",
  ...
  donate: {
    name: "Підтримати",
    subtitle: "Ви можете підтримати пожертвою наші зусилля зробити Інтернет вільнішим!",
    patreon: "Patreon",
    crypto: "Крипто",
  },
  links: {
