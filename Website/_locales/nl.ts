...
export default {
  ...
  api: {
    ...
    rights: {
      ...
      subtitle: "Gebruik door derden van deze open API is toegestaan met de volgende beperkingen:",
      bullet1: "Attributie: ",
      bullet1text:
    ...
    fetching: {
      ...
      error2: 'Een onjuist opgemaakte YouTube-ID retourneert 400 "Slecht verzoek"',
    },
  },
  help: {
    name: "Help",
    ...
    bullet4c: "Maak een screenshot van de extensiepagina van uw browser waarop de extensie is geïnstalleerd.",
  ...
  donate: {
    name: "Doneer",
    subtitle: "Met een donatie kunt u onze inspanningen om het internet gratis te houden steunen!",
    patreon: "Patreon",
    crypto: "Crypto",
  },
  links: {
