...
export default {
  ...
  home: {
    ...
    subtitle: "YouTube-dakı dislike saylarını geri qaytaran bir brauzer genişləndirməsi və API",
  ...
  install: {
    ...
    subtitle2: "Brauzeriniz hələ dəstəklənmirsə, UserScript metodunu sınayın",
    title3: "Üçüncü Tərəf Tətbiqlər",
    subtitle3: "Risk tamamilə sizə məxsusdur, bizim tərəfimizdən heç bir məsuliyyət qəbul edilmir",
    firefox: "Firefox",
    chrome: "Chrome",
    edge: "Edge",
    opera: "Opera",
  ...
  api: {
    ...
    rights: {
      ...
      subtitle: "İctimai API-nin üçüncü tərəflərin istifadəsində aşağıdakı məhdudiyyətlərə icazə verilir:",
      bullet1: "İstinad: ",
      bullet1text:
    ...
    fetching: {
      ...
      subtitle: "Müəyyən bir YouTube ID-sinin səslərini əldə etmək üçün bir nümunə: ",
      title2: "Nümunə Sorğu: ",
      url: "Sorğu URL-i: ",
      method: "Sorğu Metodu: ",
      headers: "Başlıqlar: ",
      ...
      error2: 'Səhv formatlaşdırılmış YouTube ID-si 400 "Yanlış Sorğu" olaraq qaytarılır.',
    },
  },
  help: {
    name: "Kömək",
    ...
    bullet41: " kanalından problemi bildirin (İngilis dilində) Discord serverimiz: ",
    bullet4a: "Bizə İşlətmə Sisteminiz, Brauzer Adınız və Brauzer Versiyanız haqqında məlumat verin",
    ...
    bullet4c: "Genişləndirmə quraşdırılmışkən brauzerinizin genişləndirmələr səhifəsinin ekran görüntüsünü alın.",
  ...
  faq: {
    ...
    subtitle: "Hələ də problem yaşayırsınız? Discord serverimizə qoşulmaqdan çəkinməyin! (İngilis dilində)",
  ...
  donate: {
    name: "Bağış Et",
    subtitle: "İnterneti azad etmək səylərimizdə bizə bağışınızla dəstək ola bilərsiniz!",
    patreon: "Patreon",
    crypto: "Kripto",
  },
  links: {
