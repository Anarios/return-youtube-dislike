...
export default {
  ...
  install: {
    ...
    title2: "다른 플랫폼",
    subtitle2: "당신의 브라우저가 아직 지원하지 않는 경우, 이 유저스크립트를 시도할 수 있습니다",
    title3: "서드파티 구현",
  ...
  api: {
    ...
    rights: {
      title: "사용 권한",
      subtitle: "이 오픈 API의 제 3자 사용은 다음 제한 사항들과 함꼐 허용됩니다:",
      bullet1: "저작자 표시: ",
      bullet1text:
    ...
    fetching: {
      ...
      headers: "헤더: ",
      response: "응답: ",
      error1: '유효하지 않은 유튜브 ID는 상태 코드 404 "Not Found"를 리턴합니다',
  ...
  help: {
    ...
    bullet4: "위의 내용이 도움이 되지 않는 경우, 우리의 디스코드에서 다음과 같은 채널에서 당신의 문제를 보고하세요.",
    bullet41: "디스코드: ",
    bullet4a: "운영체제, 브라우저 이름과 브라우저 버전을 우리한테 말해주세요",
    bullet4b: "콘솔창과 함께 문제가 된 페이지(예시: 유튜브 영상 페이지)의 스크린샷을 찍으세요.(",
    bullet4b1: "키를 누르세요) 아래는 스크린샷의 예시입니다.",
    bullet4c: "확장 브로그램이 설치된 당신의 브라우저의 확장 프로그램 페이지의 스크린샷을 촬영하세요.",
  ...
  faq: {
    name: "FAQ",
    title: "자주 묻는 질문",
    subtitle: "여전히 의문점이 있으신가요? 우리의 디스코드에 무료로 가입하세요!",
  ...
  donate: {
    name: "기부",
    subtitle: "기부를 통해 인터넷의 자유를 유지하려는 우리의 노력을 지원할 수 있습니다!",
    patreon: "Patreon",
    crypto: "암호화폐",
  },
  links: {
