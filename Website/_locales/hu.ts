...
export default {
  ...
  home: {
    ...
    subtitle: "Bővítmény és API, ami visszahozza a YouTube dislike számlálót.",
  ...
  install: {
    ...
    subtitle2: "Ha a böngésződ még nem támogatott, próbáld ezt a UserScriptet",
    title3: "Third Party implementációk",
    subtitle3: "Nem vállalunk érte felelősséget, használd saját belátásod szerint",
    firefox: "Firefox",
    chrome: "Chrome",
    edge: "Edge",
    opera: "Opera",
  ...
  api: {
    ...
    rights: {
      ...
      subtitle: "Ennek az API-nak a saját felhasználását az alábbiak mellett engedélyezzük:",
    ...
    fetching: {
      ...
      subtitle: "Példa egy adott YouTube videó ID adatainak lekéréséhez: ",
  ...
  help: {
    name: "Segítség",
    title: "Hibaelhárítás",
    bullet1: "Győződj meg, hogy a bővítmény legújabb verziója van telepítve, ami ",
    bullet11: "jelenleg.",
    bullet2:
    ...
    bullet4a: "Add meg az operációs rendszered, illetve a böngésződ nevét és verzióját!",
    bullet4b:
  ...
  donate: {
    name: "Támogatás",
    subtitle: "Támogathatod a szabad internetért folytatott erőfeszítéseinket egy adománnyal.",
    patreon: "Patreon",
    crypto: "Kripto",
  },
  links: {
