...
export default {
  ...
  install: {
    ...
    subtitle3: "Keine Garantie vonm unserer Seite, nutzung auf eigene Gefahr",
  },
  api: {
    name: "API",
    ...
    rights: {
      ...
      subtitle:
          ":",
      bullet1: "Attribution: ",
      bullet1text: "Dieses Projekt sollte eindeutig mit einem Link zu diesem Repo oder einem Link zu returnyoutubedislike.com gekennzeichnet werden",
      bullet2: "Begrenzung der Anfragen: ",
      bullet2text: "Es gibt Ratenbegrenzung pro Client von 100 pro Minute und 10.000 pro Tag. Dies führt zu einem Statuscode 429, der anzeigt, dass Ihre Anwendung warten sollte vor ihrer nächsten Anfrage",
    },
    url: {
    ...
    fetching: {
      title: "Grundlegende Anleitung zum Abrufen der Bewertungen",
  ...
  help: {
    name: "Hilfe",
    title: "Fehlersuche",
    bullet1: "Stell sicher, dass du die neuste Version der Erweiterung installiert haben, derzeit ist sie, ",
    bullet11: " ",
    bullet2: "Versuch die Erweiterung zu entfernen und erneut zu installieren, und starte dann den Browser neu (alle aktiven Fenster, nicht nur eine Registerkarte)",
    ...
    bullet4b: "Mach ein Screenshot der Seite mit dem Problem (von der YouTube Video Seite) mit der Konsole offen (drücke ",
  ...
  faq: {
    ...
    bullet1text: "Eine Kombination aus archivierten Daten aus der Zeit, bevor die offizielle YouTube dislike API abgeschaltet wurde, und extrapoliertem Statistiken durch Analyse des Nutzerverhaltens.",
    bullet2: "Warum updated der Dislike counter nicht?",
    bullet2text: "Momentan werden die Dislikes von Videos im Cache gespeichert und nicht sehr häufig aktualisiert. Die Aktualisierung hängt von der Popularität eines Videos ab, kann aber zwischen ein paar Stunden und ein paar Tagen dauern.",
    bullet3: "Wie funktioniert die Extension?",
    bullet3text: "Die Erweiterung sammelt die Video-ID des Videos, das du dir ansiehst, und ruft die Dislikes (und andere Felder wie views, Likes usw.) über unsere API ab. Die Erweiterung zeigt dann die Anzahl der Dislikes und das Like/Dislike verhalten auf der Seite an. Wenn Ihnen ein Video gefällt oder nicht gefällt, wird dies aufgezeichnet und an die Datenbank gesendet, so dass eine genaue Anzahl der Ablehnungen bestimmt werden kann.",
    bullet4: "Kann ich meine Dislikes mit euch teilen?",
    bullet4text: "Demnächst. Wir prüfen die Verwendung von Oauth oder einer anderen Read-Only-API mit begrenztem Umfang, damit die Ersteller ihre Dislike Anzahl verifizieren können.",
    bullet5: "Was für Daten sammelt ihr und wie werden sie verarbeitet?",
    bullet5text: 'Die Erweiterung sammelt nur Daten, die für ihr ordnungsgemäßes Funktionieren unbedingt erforderlich sind, z. B. die IP-Adresse oder die ID des Videos, das Sie sich ansehen. Keine Ihrer Daten wird jemals an Dritte verkauft werden. Wenn du mehr darüber erfahren möchtest, wie wir mit Sicherheit und Datenschutz umgehen, lesen Sie unsere <a href="https://github.com/Anarios/return-youtube-dislike/blob/main/Docs/SECURITY-FAQ.md"> Sicherheits-FAQ </a>.',
    bullet6: "Wie Funktioniert die API / das Backend?",
    bullet6text: "Das Backend verwendet archivierte Daten aus der Zeit, als die YouTube API noch die Anzahl der Dislikes, die Anzahl der Likes und Dislikes der Extension nutzer und die Hochrechnung zurückgab. In naher Zukunft werden wir es Creator ermöglichen, ihre Dislike-Anzahl einfach und sicher zu übermitteln, und wir werden die archivierten Daten von ArchiveTeam (4,56 Milliarden Videos) in unsere aktuelle Datenbank aufnehmen. Sie können sich auch ein Video zu diesem Thema ansehen.",
    bullet7: "Warum zeigt der Dislike Counter manchmal 'DISLIKES DISABLED'?",
    bullet7text: "Manchmal wird bei einem kürzlich hochgeladenen Video 'DISLIKES DISABLED' angezeigt, auch wenn der Creator es nicht deaktiviert hat. Das liegt daran, wie wir erkennen, ob Dislikes deaktiviert sind, es sollte in ein paar Stunden verschwinden oder indem man das Video Liked oder disliked und die Seite aktualisiert (hoffentlich).",
  },
  donate: {
    name: "Spenden",
