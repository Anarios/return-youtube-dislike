...
export default {
    ...
    api: {
        ...
        fetching: {
            ...
            error2:
              'Eine falsch formatierte YouTube-ID liefert den Statuscode 400 "Bad Request"',
        },
    },
    help: {
        name: "Hilfe",
        ...
        bullet4c:
          "Mache ein Screenshot von deinen installierten Erweiterungen in deinem Browser .",
    ...
    donate: {
        name: "Spenden",
        subtitle:
          "Du kannst unsere Bemühungen, das Internet frei zu halten, mit einer Spende unterstützen !",
    },
    links: {
        name: "Links",
        title: "Project Links",
