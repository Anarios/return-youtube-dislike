...
function initializeShowUpdatePopup() {
  chrome.storage.sync.get(["showUpdatePopup"], (res) => {
    handleShowUpdatePopupChangeEvent(res.showUpdatePopup);
  });
}
...
function handleShowUpdatePopupChangeEvent(value) {
  config.showUpdatePopup = value;
  document.getElementById("show_update_popup").checked = value;
}
