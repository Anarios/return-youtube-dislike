...
function getButtons() {
  ...
  return (_document$getElementB = document.getElementById("menu-container")) ===
    null || _document$getElementB === void 0
    ? void 0
    : _document$getElementB.querySelector("#top-level-buttons-computed");
}
...
function setEventListeners(evt) {
  function checkForJS_Finish() {
    ...
    if (
      (_getButtons = getButtons()) !== null &&
      _getButtons !== void 0 &&
      _getButtons.offsetParent &&
      isVideoLoaded()
    ) {
