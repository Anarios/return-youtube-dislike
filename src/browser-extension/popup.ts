...
.addEventListener('click', function () {
  browser.runtime.sendMessage({ message: 'get_auth_token' });
});

document.querySelector("#log_off").addEventListener("click", function () {
  browser.runtime.sendMessage({ message: "log_off" });
});
*/
